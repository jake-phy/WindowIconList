...
IconLabelButton.prototype = {
    _init: function(icon) {
        ...
        this._container = new Cinnamon.GenericContainer({ name: 'iconLabelButton' });
...
MyAppletBox.prototype = {
    ...
    acceptDrop: function(source, actor, x, y, time) {  
        ...
        if ( source.isFavapp || source.wasFavapp || source.isDraggableApp ) {
                ...
                if (!(source.isDraggableApp || (children[i]._delegate instanceof AppletDir.applet.AppGroup))) continue;
